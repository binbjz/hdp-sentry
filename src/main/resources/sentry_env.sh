...
sentry_privileges[DBWrite]="server=server1->db=db4create->action=create,server=server1->db=db4drop->action=create,server=server1->db=db4drop_cascade->action=create,server=server1->db=db4tbl->action=create,server=server1->db=db4alter->action=create,server=server1->db=test_db->action=create,server=server1->db=db4create->action=alter,server=server1->db=db4drop->action=alter,server=server1->db=db4drop_cascade->action=alter,server=server1->db=db4tbl->action=alter,server=server1->db=db4alter->action=alter,server=server1->db=test_db->action=alter,server=server1->db=db4create->action=insert,server=server1->db=db4drop->action=insert,server=server1->db=db4drop_cascade->action=insert,server=server1->db=db4tbl->action=insert,server=server1->db=db4alter->action=insert,server=server1->db=test_db->action=insert"
