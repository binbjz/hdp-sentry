...
CREATE TABLE encrypt_db4tbl.tbl4view(c0 string, encrypt_c1 string, encrypt_c2 string) PARTITIONED BY (col10 STRING, col20 STRING)
...
CREATE VIEW encrypt_db4tbl.view4serde_0 AS SELECT c0, encrypt_c1, encrypt_c2 FROM encrypt_db4tbl.tbl4view;
...
SELECT c0, encrypt_c1, encrypt_c2 FROM encrypt_db4tbl.tbl4view;
SELECT c0, encrypt_c1, encrypt_c2 FROM encrypt_db4tbl.view4serde_1;
