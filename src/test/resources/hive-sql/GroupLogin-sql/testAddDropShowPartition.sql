...
SELECT ad_activity_key, ad_activity_id, ad_activity_type, poi_id FROM mart_waimai.dim_ad_cpc_activity_poi WHERE dt >= 20110102 AND 20110122 >= dt AND ad_activity_type != 0;
