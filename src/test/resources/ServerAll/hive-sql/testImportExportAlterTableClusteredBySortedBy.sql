...
CREATE TABLE db4alter.staged_employees (
  name STRING
 ,salary FLOAT
 ,subordinates ARRAY<STRING>
 ,deductions MAP<STRING, FLOAT>
...
INTO TABLE db4alter.staged_employees
PARTITION (country = 'US', state = 'CA');

EXPORT TABLE db4alter.staged_employees PARTITION (country = 'US', state = 'CA') TO '/tmp/employee';
...
ALTER TABLE db4alter.staged_employees TOUCH PARTITION (country = 'US', state = 'CA') ;
...
DROP TABLE db4alter.staged_employees;
