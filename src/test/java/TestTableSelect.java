...
public class TestTableSelect {

    /**
     * Add role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r table_select
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r table_select -g table_select_group
     * /opt/meituan/sentry/bin/sentryShell --conf /opt/meituan/sentry/conf/sentry-site.xml --grant_privilege_role --role table_select --privilege server=server1->db=test_db->table=test_tbl->action=select
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_role -g table_select_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_privilege -r table_select
     */
     ...
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --revoke_privilege_role -r table_select -p server=server1->db=test_db->table=test_tbl->action=select
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --delete_role_group -r table_select -g table_select_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --drop_role -r table_select
     */
 ...
 * test SHOW TABLES
    ...
    SHOW TABLES LIKE 'e*';
        -- 1022 SHOW GRANT ROLE
            单独测试
*/
public void testAlterDescribeTable122(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
...
*/
public void testAlterDescribeTable233(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
...
public void testAlterDescribeTable24(){
     ...
     */
    public void testAddJarCreateTmpFunction25(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
