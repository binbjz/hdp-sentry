...
//        UtilTool.privilHandler(className, preSql, "setup");
    ...
    public void testDBInsert(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        logger.debug("===============================================");
        logger.debug("DBDrop--> running testcase: " + id);
        logger.debug("===============================================");
