...
public class TestTableAlter {

    /**
     * Add role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r table_alter
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r table_alter -g table_alter_group
     * /opt/meituan/sentry/bin/sentryShell --grant_privilege_role --role table_alter --privilege server=server1->db=test_db->table=test_tbl->action=alter --conf /opt/meituan/sentry/conf/sentry-site.xml
     */

    /**
     * Remove role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell --revoke_privilege_role -r table_alter -p server=server1->db=test_db->table=test_tbl->action=alter -conf /opt/meituan/sentry/conf/sentry-site.xml
     * /opt/meituan/sentry/bin/sentryShell --delete_role_group -r table_alter -g table_alter_group -conf /opt/meituan/sentry/conf/sentry-site.xml
     * /opt/meituan/sentry/bin/sentryShell --drop_role -r table_alter -conf /opt/meituan/sentry/conf/sentry-site.xml
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell --list_role -g table_alter_group -conf /opt/meituan/sentry/conf/sentry-site.xml
     * /opt/meituan/sentry/bin/sentryShell --list_privilege -r table_alter -conf /opt/meituan/sentry/conf/sentry-site.xml
     */
...
*/
     ...
     * DROP DATABASE test_db;
     */
    public void testAlterDescribeTable100(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
     ...
     */
    public void testAlterDescribeTable101(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
 ...
 * test SHOW TABLES
    ...
    SHOW TABLES LIKE 'e*';
        -- 1022 SHOW GRANT ROLE
            单独测试
*/
public void testAlterDescribeTable103(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
...
*/
public void testAlterDescribeTable105(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
}
 ...
 *
    ...
    WHERE se.cnty = 'US';
*/
public void testAlterDescribeTable106(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
     ...
     */
    public void testAddJarCreateTmpFunction107(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     * DROP TABLE test_serde;
     */
    public void testAlterDescribeTable108(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     */
    public void testAlterDescribeTable109(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     */
    public void testAlterDescribeTable110(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
