...
public class DBWrite {
    ...
    @Test
    @UseDataProvider("dataProviderDBWrite")
    public void testDBWrite(String id, String tag, String desc, String sqlType, String sqlFile, String
    ...
    @DataProvider
    public static Object[][] dataProviderDBWrite() {
