...
public class TableAll {
    ...
    public static void setUp() {
        System.out.println("setUp TableAll......");
    ...
    public void testDBInsert(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        System.out.println("===============================================");
        System.out.println("TableAll--> running testcase: " + id);
        System.out.println("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderTableAll() {
    ...
    public static void cleanUp() {
        System.out.println("cleanUp TableAll......");
