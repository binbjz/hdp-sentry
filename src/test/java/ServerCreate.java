...
public class ServerCreate {
    ...
    public static void setUp() {
        System.out.println("setUp ServerCreate......");
    ...
    public void testServerAll(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        System.out.println("===============================================");
        System.out.println("ServerCreate--> running testcase: " + id);
        System.out.println("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderServerCreate() {
    ...
    public static void cleanUp() {
        System.out.println("cleanUp ServerCreate......");
