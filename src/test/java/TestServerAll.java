...
public class TestServerAll {
    ...
    public void testServerAll(String id, String tag, String desc, String sqlType, String sqlFile, String resultType, String resultFile) {
        ...
        String hiveSql = SentryConstant.tSrc + File.separator + TraceHandler.getSTElement(0, "className") + File.separator + SentryConstant.hiveSqlSrc + File.separator + resultFile;
