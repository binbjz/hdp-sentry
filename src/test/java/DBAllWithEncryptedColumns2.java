...
public class DBAllWithEncryptedColumns2 {
    ...
    public static void setUp() {
        System.out.println("setUp DBAllWithEncryptedColumns2......");
    ...
    @Test
    @UseDataProvider("dataProviderTestDBAllWithEncryptedColumns2")
    public void testDBInsert(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        System.out.println("===============================================");
        System.out.println("DBAllWithEncryptedColumns2--> running testcase: " + id);
        System.out.println("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderTestDBAllWithEncryptedColumns2() {
    ...
    public static void cleanUp() {
        System.out.println("cleanUp DBAllWithEncryptedColumns2......");
