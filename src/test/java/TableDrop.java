...
public class TableDrop {
    ...
    public static void setUp() {
        System.out.println("setUp TableDrop......");
    ...
    @Test
    @UseDataProvider("dataProviderTableDrop")
    public void testTableDrop(String id, String tag, String desc, String sqlType, String sqlFile, String
            resultType, String resultFile) {
        System.out.println("===============================================");
        System.out.println("TableDrop--> running testcase: " + id);
        System.out.println("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderTableDrop() {
    ...
    public static void cleanUp() {
        System.out.println("cleanUp TableDrop......");
