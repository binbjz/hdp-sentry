...
public class TestServerSelect {

    /**
     * Add role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r server_select
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r server_select -g server_select_group
     * /opt/meituan/sentry/bin/sentryShell --conf /opt/meituan/sentry/conf/sentry-site.xml --grant_privilege_role --role server_select --privilege server=server1->action=select
     */

    /**
     * Remove role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --revoke_privilege_role -r server_select -p server=server1->action=select
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --delete_role_group -r server_select -g server_select_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --drop_role -r server_select
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_role -g server_select_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_privilege -r server_select
     */
...
*/
     ...
     * DROP DATABASE test_db;
     */
    public void testAlterDescribeTable21(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
 ...
 * test SHOW TABLES
    ...
    SHOW TABLES LIKE 'e*';
        -- 1022 SHOW GRANT ROLE
            单独测试
*/
public void testAlterDescribeTable24(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
 ...
 *
    ...
    WHERE se.cnty = 'US';
*/
public void testAlterDescribeTable26(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
     ...
     */
    public void testAddJarCreateTmpFunction27(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     * DROP TABLE test_serde;
     */
    public void testAlterDescribeTable28(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     */
    public void testAlterDescribeTable29(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     */
    public void testAlterDescribeTable30(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
