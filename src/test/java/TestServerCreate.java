...
public class TestServerCreate {
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_role -g server_create_group
...
public void testAlterDescribeTable25(){
     ...
     */
    public void testAddJarCreateTmpFunction26(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
