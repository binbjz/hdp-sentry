...
public class ServerInsert {
    ...
    public static void setUp() {
        logger.debug("setUp ServerInsert......");
    ...
    public void testServerInsert(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        logger.debug("===============================================");
        logger.debug("ServerInsert--> running testcase: " + id);
        logger.debug("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderServerInsert() {
    ...
    public static void cleanUp() {
        logger.debug("cleanUp ServerInsert......");
