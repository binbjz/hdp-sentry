...
public class DBAllWithEncryptedColumns {
    ...
    private static final String sqlOutputPath = SentryConstant.tSrc + File.separator + SentryConstant.hiveOutput + File.separator + caseName + File.separator + SentryConstant.sqlOutput;
    ...
    public void testDBInsert(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        logger.info("===============================================");
        String hiveSql = SentryConstant.hiveExec + " -f " + SentryConstant.encryptColumnSqlSrc + File.separator + sqlFile;
