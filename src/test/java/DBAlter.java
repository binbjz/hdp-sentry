...
//        UtilTool.privilHandler(className, preSql, "setup");
    ...
    @Test
    @UseDataProvider("dataProviderDBAlter")
    public void testDBAlter(String id, String tag, String desc, String sqlType, String sqlFile, String
            resultType, String resultFile) {
        System.out.println("===============================================");
        System.out.println("DBAlter--> running testcase: " + id);
        System.out.println("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderDBAlter() {
    ...
    public static void cleanUp() {
        ...
        System.out.println("cleanUp DBAlter......");
