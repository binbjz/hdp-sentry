...
public class DBAll {
    ...
    public static void setUp() {
        System.out.println("setUp DBAll......");
    ...
    @Test
    @UseDataProvider("dataProviderDBAll")
    public void testDBAll(String id, String tag, String desc, String sqlType, String sqlFile, String
            resultType, String resultFile) {
        System.out.println("===============================================");
        System.out.println("DBAll--> running testcase: " + id);
        System.out.println("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderDBAll() {
    ...
    public static void cleanUp() {
        System.out.println("cleanUp DBAll......");
