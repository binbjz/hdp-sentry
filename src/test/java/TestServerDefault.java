...
public class TestServerDefault {
     ...
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r server_default
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r server_default -g server_default_group
     * /opt/meituan/sentry/bin/sentryShell --conf /opt/meituan/sentry/conf/sentry-site.xml --grant_privilege_role --role server_default --privilege server=server1
     */

    /**
     * Remove role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --revoke_privilege_role -r server_default -p server=server1
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --delete_role_group -r server_default -g server_default_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --drop_role -r server_default
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_role -g server_default_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_privilege -r server_default
     */
...
*/
public void testAlterDescribeTable7(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
 ...
 * SELECT se.* FROM staged_employees se WHERE se.cnty = 'US';
 *
...
public void testAlterDescribeTable22(){
     ...
     */
    public void testAddJarCreateTmpFunction23(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
