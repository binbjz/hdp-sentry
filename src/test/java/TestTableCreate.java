...
public class TestTableCreate {
     ...
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r table_create
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r table_create -g table_create_group
     * /opt/meituan/sentry/bin/sentryShell --grant_privilege_role --role table_create --privilege server=server1->db=test_db->table=test_tbl->action=create --conf /opt/meituan/sentry/conf/sentry-site.xml
     */
