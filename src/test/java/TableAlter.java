...
public class TableAlter {
    ...
    public static void setUp() {
        System.out.println("setUp TableAlter......");
    ...
    public void testDBInsert(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        System.out.println("===============================================");
        System.out.println("TableAlter--> running testcase: " + id);
        System.out.println("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderTableAlter() {
    ...
    public static void cleanUp() {
        System.out.println("cleanUp TableAlter......");
