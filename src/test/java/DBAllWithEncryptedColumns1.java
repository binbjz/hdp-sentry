...
public class DBAllWithEncryptedColumns1 {
    ...
    public static void setUp() {
        logger.debug("setUp DBAllWithEncryptedColumns1......");
    ...
    @Test
    @UseDataProvider("dataProviderTestDBAllWithEncryptedColumns1")
    public void testDBInsert(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        logger.debug("===============================================");
        logger.debug("DBAllWithEncryptedColumns1--> running testcase: " + id);
        logger.debug("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderTestDBAllWithEncryptedColumns1() {
    ...
    public static void cleanUp() {
        logger.debug("cleanUp DBAllWithEncryptedColumns1......");
