...
public class DBAllWithEncryptedColumns3 {
    ...
    public static void setUp() {
        System.out.println("setUp DBAllWithEncryptedColumns3......");
    ...
    public void testDBInsert(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        System.out.println("===============================================");
        System.out.println("DBAllWithEncryptedColumns3--> running testcase: " + id);
        System.out.println("===============================================");
    ...
    public static void cleanUp() {
        System.out.println("cleanUp DBAllWithEncryptedColumns3......");
