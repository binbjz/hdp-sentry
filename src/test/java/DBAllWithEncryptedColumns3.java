...
public class DBAllWithEncryptedColumns3 {
    ...
    public static void setUp() {
        logger.debug("setUp DBAllWithEncryptedColumns3......");
    ...
    public void testDBInsert(String id, String tag, String desc, String sqlType, String sqlFile, String
        ...
        logger.debug("===============================================");
        logger.debug("DBAllWithEncryptedColumns3--> running testcase: " + id);
        logger.debug("===============================================");
    ...
    public static void cleanUp() {
        logger.debug("cleanUp DBAllWithEncryptedColumns3......");
