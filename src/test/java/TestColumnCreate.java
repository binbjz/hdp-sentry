...
public class TestColumnCreate {

    /**
     * Add role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r column_create
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r column_create -g column_create_group
     * /opt/meituan/sentry/bin/sentryShell --conf /opt/meituan/sentry/conf/sentry-site.xml --grant_privilege_role --role column_create --privilege server=server1->db=test_db->table=test_tbl->column=a->action=create,server=server1->db=test_db->table=test_tbl->column=b->action=create
     */

    /**
     * Remove role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --revoke_privilege_role -r column_create -p server=server1->db=test_db->table=test_tbl->column=a->action=create,server=server1->db=test_db->table=test_tbl->column=b->action=create
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --delete_role_group -r column_create -g column_create_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --drop_role -r column_create
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_role -g column_create_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_privilege -r column_create
     */
 ...
 * test SHOW TABLES
    ...
    SHOW TABLES LIKE 'e*';
        -- 1022 SHOW GRANT ROLE
            单独测试
*/
public void testAlterDescribeTable10(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
...
*/
public void testAlterDescribeTable22(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
 ...
 *
    ...
    WHERE se.cnty = 'US';
*/
public void testAlterDescribeTable23(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
     ...
     */
    public void testAddJarCreateTmpFunction24(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     * DROP TABLE test_serde;
     */
    public void testAlterDescribeTable25(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     */
    public void testAlterDescribeTabl26e(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     */
    public void testAlterDescribeTable27(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
