...
public class TestColumnSelect {

    /**
     * Add role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r column_select
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r column_select -g column_select_group
     * /opt/meituan/sentry/bin/sentryShell --conf /opt/meituan/sentry/conf/sentry-site.xml --grant_privilege_role --role column_select --privilege server=server1->db=test_db->table=test_tbl->column=a->action=select,server=server1->db=test_db->table=test_tbl->column=b->action=select
     */

    /**
     * Remove role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --revoke_privilege_role -r column_select -p server=server1->db=test_db->table=test_tbl->column=a->action=select,server=server1->db=test_db->table=test_tbl->column=b->action=select
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --delete_role_group -r column_select -g column_select_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --drop_role -r column_select
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_role -g column_select_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_privilege -r column_select
     */
...
public void testInsertOverwriteTable(){
     ...
     */
    public void testInsertOverwriteDirectory(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     */
    public void testImportExortTable(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
    ...
    */
   public void testAlterTableTouch(){
       Assert.assertEquals("hello", "hello");
       System.out.println("~~~~~~~~~~~");
   }
