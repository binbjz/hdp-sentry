...
public class TestColumnInsert {

    /**
     * Add role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r column_insert
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r column_insert -g column_insert_group
     * /opt/meituan/sentry/bin/sentryShell --conf /opt/meituan/sentry/conf/sentry-site.xml --grant_privilege_role --role column_insert --privilege server=server1->db=test_db->table=test_tbl->column=a->action=insert,server=server1->db=test_db->table=test_tbl->column=b->action=insert
     */

    /**
     * Remove role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --revoke_privilege_role -r column_insert -p server=server1->db=test_db->table=test_tbl->column=a->action=insert,server=server1->db=test_db->table=test_tbl->column=b->action=insert
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --delete_role_group -r column_insert -g column_insert_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --drop_role -r column_insert
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_role -g column_insert_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_privilege -r column_insert
     */
...
public void testAlterDescribeTable14(){
     ...
     */
    public void testAddJarCreateTmpFunction15(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
