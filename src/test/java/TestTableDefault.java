...
public class TestTableDefault {

    /**
     * Add role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r table_default
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r table_default -g table_default_group
     * /opt/meituan/sentry/bin/sentryShell --grant_privilege_role --role table_default --privilege server=server1->db=test_db->table=test_tbl --conf /opt/meituan/sentry/conf/sentry-site.xml
     */

    /**
     * Remove role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell --revoke_privilege_role -r table_default -p server=server1->db=test_db->table=test_tbl -conf /opt/meituan/sentry/conf/sentry-site.xml
     * /opt/meituan/sentry/bin/sentryShell --delete_role_group -r table_default -g table_default_group -conf /opt/meituan/sentry/conf/sentry-site.xml
     * /opt/meituan/sentry/bin/sentryShell --drop_role -r table_default -conf /opt/meituan/sentry/conf/sentry-site.xml
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell --list_role -g table_default_group -conf /opt/meituan/sentry/conf/sentry-site.xml
     * /opt/meituan/sentry/bin/sentryShell --list_privilege -r table_default -conf /opt/meituan/sentry/conf/sentry-site.xml
     */
...
*/
public void testAlterDescribeTable102(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
...
*/
public void testAlterDescribeTable104(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
...
public void testAlterDescribeTable105(){
     ...
     */
    public void testAddJarCreateTmpFunction106(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     * DROP TABLE test_serde;
     */
    public void testAlterDescribeTable107(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
