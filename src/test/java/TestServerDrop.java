...
public class TestServerDrop {
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r server_drop -g server_drop_group
     * /opt/meituan/sentry/bin/sentryShell --conf /opt/meituan/sentry/conf/sentry-site.xml --grant_privilege_role --role server_drop --privilege server=server1->action=drop
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --delete_role_group -r server_drop -g server_drop_group
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_role -g server_drop_group
...
public void testAlterDescribeTable30(){
     ...
     */
    public void testAlterDescribeTable32(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
     ...
     */
    public void testAlterDescribeTable33(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
