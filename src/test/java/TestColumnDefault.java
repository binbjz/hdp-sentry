...
public class TestColumnDefault {

    /**
     * Add role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -create_role -r column_default
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml -add_role_group -r column_default -g column_default_group
     * /opt/meituan/sentry/bin/sentryShell --conf /opt/meituan/sentry/conf/sentry-site.xml --grant_privilege_role --role column_default --privilege server=server1->db=test_db->table=test_tbl->column=a,server=server1->db=test_db->table=test_tbl->column=b
     */

    /**
     * Remove role, group and privilege
     *
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --revoke_privilege_role -r column_default -p server=server1->db=test_db->table=test_tbl->column=a,server=server1->db=test_db->table=test_tbl->column=b
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --delete_role_group -r column_default -g column_default_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --drop_role -r column_default
     */
     ...
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_role -g column_default_group
     * /opt/meituan/sentry/bin/sentryShell -conf /opt/meituan/sentry/conf/sentry-site.xml --list_privilege -r column_default
     */


    /**
     * all_db_role=server=server1
     * all_db_mart_hdp=server=server1->db=mart_hdp
     * all_db_mart_hdp_test_all=server=server1->db=mart_hdp_test
     * ctas=server=server1->db=mart_hdp_test->table=sentry_test,server=server1->db=mart_hdp_test
     * all_db_mart_hdp_test=server=server1->db=mart_hdp_test->action=select
     * all_db_mart_hdp_test_column=server=server1->db=mart_hdp_test->table=sentry_test->column=a,server=server1->db=mart_hdp_test->table=sentry_test->column=c
     * all_db_bi=server=server1->db=bi
     * all_db_mart_ugc=server=server1->db=mart_ugc
     */
...
*/
     ...
     * DROP DATABASE test_db;
     */
    public void testAlterDescribeTable3(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
     ...
     */
    public void testAlterDescribeTable4(){
        Assert.assertEquals("hello", "hello");
        System.out.println("~~~~~~~~~~~");
    }
...
*/
public void testAlterDescribeTable5(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
    ...
    * 单独测试
    */
   public void testAlterDescribeTable17(){
       Assert.assertEquals("hello", "hello");
       System.out.println("~~~~~~~~~~~");
   }
...
*/
public void testAlterDescribeTable8(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
 ...
 *
    ...
    WHERE se.cnty = 'US';
*/
public void testAlterDescribeTable9(){
    Assert.assertEquals("hello", "hello");
    System.out.println("~~~~~~~~~~~");
