...
public class ServerWrite {
    ...
    public static void setUp() {
        logger.info("setUp ServerWrite......");
    }


    @Test
    @UseDataProvider("dataProviderServerWrite")
    public void testServerWrite(String id, String tag, String desc, String sqlType, String sqlFile, String
            resultType, String resultFile) {
        logger.info("===============================================");
        logger.info("ServerWrite--> running testcase: " + id);
        logger.info("===============================================");
    ...
    @DataProvider
    public static Object[][] dataProviderServerWrite() {
    ...
    public static void cleanUp() {
        logger.info("cleanUp ServerWrite......");
    }
}
