...
sentry_privileges[TableAll]="server=server1->db=test_db->table=tbl4drop->action=all,server=server1->db=test_db->table=view4drop->action=all,server=server1->db=test_db->table=tbl4alter->action=all,server=server1->db=test_db->table=log_messages->action=all,server=server1->db=test_db->table=log_messages_external->action=all,server=server1->db=test_db->table=log_messages2->action=all,server=server1->db=test_db->table=log_messages2_external->action=all,server=server1->db=test_db->table=supply->action=all,server=server1->db=test_db->table=collecttest->action=all,server=server1->db=test_db->table=session_test->action=all,server=server1->db=test_db->table=sessionization_step_one_origins->action=all,server=server1->db=test_db->table=partition_table001->action=all,server=server1->db=test_db->table=partition_table002->action=all,server=server1->db=test_db->table=table001->action=all,server=server1->db=test_db->table=table002->action=all,server=server1->db=test_db->table=teacher->action=all,server=server1->db=test_db->table=whoyouare->action=all,server=server1->db=test_db->table=test_serde->action=all,server=server1->db=test_db->table=test_partition_serde->action=all,server=server1->db=test_db->table=test_enable_disable->action=all,server=server1->db=test_db->table=test_enable_disable1->action=all,server=server1->db=test_db->table=test_enable_disable2->action=all,server=server1->db=test_db->table=employees->action=all,server=server1->db=test_db->table=employees02->action=all,server=server1->db=test_db->table=staged_employees->action=all,server=server1->db=test_db->table=staged_employees02->action=all,server=server1->db=test_db->table=employees_props->action=all,server=server1->db=test_db->table=test_msck->action=all"
#sentry_privileges[TableAlter]="server=server1->db=test_db->table=test_tble->action=all,server=server1->db=test_db->table=tbl4drop->action=all,server=server1->db=test_db->table=view4drop->action=all,server=server1->db=test_db->table=tbl4alter->action=all,server=server1->db=test_db->table=log_messages->action=all,server=server1->db=test_db->table=log_messages_external->action=all,server=server1->db=test_db->table=supply->action=all,server=server1->db=test_db->table=collecttest->action=all,server=server1->db=test_db->table=session_test->action=all,server=server1->db=test_db->table=sessionization_step_one_origins->action=all,server=server1->db=test_db->table=partition_table001->action=all,server=server1->db=test_db->table=partition_table002->action=all,server=server1->db=test_db->table=table001->action=all,server=server1->db=test_db->table=table002->action=all,server=server1->db=test_db->table=teacher1->action=all,server=server1->db=test_db->table=teacher2->action=all,server=server1->db=test_db->table=whoyouare->action=all,server=server1->db=test_db->table=test_serde->action=all,server=server1->db=test_db->table=test_partition_serde->action=all,server=server1->db=test_db->table=employees_props->action=all,server=server1->db=test_db->table=test_enable_disable->action=all,server=server1->db=test_db->table=test_enable_disable1->action=all,server=server1->db=test_db->table=test_enable_disable2->action=all,server=server1->db=test_db->table=employees->action=all,server=server1->db=test_db->table=staged_employees->action=all,server=server1->db=test_db->table=test_msck->action=all"
#sentry_privileges[TableCreate]="server=server1->db=test_db->table=test_tble->action=all,server=server1->db=test_db->table=tbl4drop->action=all,server=server1->db=test_db->table=view4drop->action=all,server=server1->db=test_db->table=tbl4alter->action=all,server=server1->db=test_db->table=log_messages->action=all,server=server1->db=test_db->table=log_messages_external->action=all,server=server1->db=test_db->table=supply->action=all,server=server1->db=test_db->table=collecttest->action=all,server=server1->db=test_db->table=session_test->action=all,server=server1->db=test_db->table=sessionization_step_one_origins->action=all,server=server1->db=test_db->table=partition_table001->action=all,server=server1->db=test_db->table=partition_table002->action=all,server=server1->db=test_db->table=table001->action=all,server=server1->db=test_db->table=table002->action=all,server=server1->db=test_db->table=teacher1->action=all,server=server1->db=test_db->table=teacher2->action=all,server=server1->db=test_db->table=whoyouare->action=all,server=server1->db=test_db->table=test_serde->action=all,server=server1->db=test_db->table=test_partition_serde->action=all,server=server1->db=test_db->table=employees_props->action=all,server=server1->db=test_db->table=test_enable_disable->action=all,server=server1->db=test_db->table=test_enable_disable1->action=all,server=server1->db=test_db->table=test_enable_disable2->action=all,server=server1->db=test_db->table=employees->action=all,server=server1->db=test_db->table=staged_employees->action=all,server=server1->db=test_db->table=test_msck->action=all"
#sentry_privileges[TableDrop]="server=server1->db=test_db->table=test_tble->action=all,server=server1->db=test_db->table=tbl4drop->action=all,server=server1->db=test_db->table=view4drop->action=all,server=server1->db=test_db->table=tbl4alter->action=all,server=server1->db=test_db->table=log_messages->action=all,server=server1->db=test_db->table=log_messages_external->action=all,server=server1->db=test_db->table=supply->action=all,server=server1->db=test_db->table=collecttest->action=all,server=server1->db=test_db->table=session_test->action=all,server=server1->db=test_db->table=sessionization_step_one_origins->action=all,server=server1->db=test_db->table=partition_table001->action=all,server=server1->db=test_db->table=partition_table002->action=all,server=server1->db=test_db->table=table001->action=all,server=server1->db=test_db->table=table002->action=all,server=server1->db=test_db->table=teacher1->action=all,server=server1->db=test_db->table=teacher2->action=all,server=server1->db=test_db->table=whoyouare->action=all,server=server1->db=test_db->table=test_serde->action=all,server=server1->db=test_db->table=test_partition_serde->action=all,server=server1->db=test_db->table=employees_props->action=all,server=server1->db=test_db->table=test_enable_disable->action=all,server=server1->db=test_db->table=test_enable_disable1->action=all,server=server1->db=test_db->table=test_enable_disable2->action=all,server=server1->db=test_db->table=employees->action=all,server=server1->db=test_db->table=staged_employees->action=all,server=server1->db=test_db->table=test_msck->action=all"
#sentry_privileges[TableInsert]="server=server1->db=test_db->table=test_tble->action=all,server=server1->db=test_db->table=tbl4drop->action=all,server=server1->db=test_db->table=view4drop->action=all,server=server1->db=test_db->table=tbl4alter->action=all,server=server1->db=test_db->table=log_messages->action=all,server=server1->db=test_db->table=log_messages_external->action=all,server=server1->db=test_db->table=supply->action=all,server=server1->db=test_db->table=collecttest->action=all,server=server1->db=test_db->table=session_test->action=all,server=server1->db=test_db->table=sessionization_step_one_origins->action=all,server=server1->db=test_db->table=partition_table001->action=all,server=server1->db=test_db->table=partition_table002->action=all,server=server1->db=test_db->table=table001->action=all,server=server1->db=test_db->table=table002->action=all,server=server1->db=test_db->table=teacher1->action=all,server=server1->db=test_db->table=teacher2->action=all,server=server1->db=test_db->table=whoyouare->action=all,server=server1->db=test_db->table=test_serde->action=all,server=server1->db=test_db->table=test_partition_serde->action=all,server=server1->db=test_db->table=employees_props->action=all,server=server1->db=test_db->table=test_enable_disable->action=all,server=server1->db=test_db->table=test_enable_disable1->action=all,server=server1->db=test_db->table=test_enable_disable2->action=all,server=server1->db=test_db->table=employees->action=all,server=server1->db=test_db->table=staged_employees->action=all,server=server1->db=test_db->table=test_msck->action=all"
#sentry_privileges[TableSelect]="server=server1->db=test_db->table=test_tble->action=all,server=server1->db=test_db->table=tbl4drop->action=all,server=server1->db=test_db->table=view4drop->action=all,server=server1->db=test_db->table=tbl4alter->action=all,server=server1->db=test_db->table=log_messages->action=all,server=server1->db=test_db->table=log_messages_external->action=all,server=server1->db=test_db->table=supply->action=all,server=server1->db=test_db->table=collecttest->action=all,server=server1->db=test_db->table=session_test->action=all,server=server1->db=test_db->table=sessionization_step_one_origins->action=all,server=server1->db=test_db->table=partition_table001->action=all,server=server1->db=test_db->table=partition_table002->action=all,server=server1->db=test_db->table=table001->action=all,server=server1->db=test_db->table=table002->action=all,server=server1->db=test_db->table=teacher1->action=all,server=server1->db=test_db->table=teacher2->action=all,server=server1->db=test_db->table=whoyouare->action=all,server=server1->db=test_db->table=test_serde->action=all,server=server1->db=test_db->table=test_partition_serde->action=all,server=server1->db=test_db->table=employees_props->action=all,server=server1->db=test_db->table=test_enable_disable->action=all,server=server1->db=test_db->table=test_enable_disable1->action=all,server=server1->db=test_db->table=test_enable_disable2->action=all,server=server1->db=test_db->table=employees->action=all,server=server1->db=test_db->table=staged_employees->action=all,server=server1->db=test_db->table=test_msck->action=all"
