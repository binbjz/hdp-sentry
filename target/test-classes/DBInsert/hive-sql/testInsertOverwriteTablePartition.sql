...
INSERT OVERWRITE TABLE db4overwrite.partition_table002 PARTITION (dt, ht) SELECT * FROM db4overwrite.partition_table001 WHERE dt='20150617' AND name='baidu';
SELECT * FROM db4overwrite.partition_table002;

INSERT OVERWRITE TABLE db4overwrite.partition_table002 PARTITION (dt='20150617', ht) SELECT name, ip, ht FROM db4overwrite.partition_table001 WHERE dt='20150617' and ht='00' AND name='alibaba';
SELECT * FROM db4overwrite.partition_table002;
