...
ALTER TABLE testdb.tbl4fileformat PARTITION (year=2012, month=1, day= ) SET FILEFORMAT SEQUENCEFILE;
...
DESCRIBE testdb.tbl4fileformat;
...
DESCRIBE testdb.tbl4fileformat_external;
