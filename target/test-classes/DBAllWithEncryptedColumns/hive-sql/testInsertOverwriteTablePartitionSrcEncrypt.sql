...
dfs -cat /user/warehouse/hive/encrypt_db4data.db/partition_table_src;

SET hive.exec.dynamic.partition=true;
SET hive.exec.dynamic.partition.mode=nonstrict;
SET hive.cli.print.header=true;

CREATE TABLE IF NOT EXISTS encrypt_db4data.partition_table002 LIKE test_db.partition_table_src;
